...
/* Données de jeu */
import { BUREAU_8_DEVERROUILLE, CREDITS_ID, HOME_SCREEN_ID } from '../donnees/list_ids_room.donnee'
...
export default class Index extends React.Component<{},{player: Player},any> {
    constructor(props) {
        ...
        this.state = {
            player: new Player(
                BUREAU_8_DEVERROUILLE,//HOME_SCREEN_ID,                      // identifiant de la salle dans laquelle commencer
